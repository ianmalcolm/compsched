...
import loea.sched.scheduler.TaskBrokerSandwich;
...
public class ScalableSimulatorSandwich {
	...
	public static void main(String[] args) {
		...
		Log.printLine("Starting Scalable Simulator Sandwich...");
		...
		try {
			...
			TaskBrokerSandwich broker = new TaskBrokerSandwich("TaskBroker");

...
/**
 * This Scheduler is developed based on CloudletSchedulerSpaceShared class in
 * CloudSim
 * 
 * @author ian
 *
 */
public class SubtaskScheduler extends CloudletScheduler {
